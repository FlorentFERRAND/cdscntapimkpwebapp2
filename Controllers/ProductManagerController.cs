...
//                MyRequest._Token = HttpContext.Session.GetString(SessionToken);
  //              MyRequest._EnvironmentSelected = (EnvironmentEnum)Enum.Parse(typeof(EnvironmentEnum),HttpContext.Session.GetString(SessionEnvironment));
         ...
         * Fais le 12/07/2017
         **/
        public ActionResult GetAllAllowedCategoryTreeRequestFlo()
        {
            Request MyRequest = new GetAllAllowedCategoryTreeRequestFlo();
            //GetSessionData(ref MyRequest);
            return View(MyRequest);
        }
        [HttpPost]
        public ActionResult GetAllAllowedCategoryTreeMessageFlo(GetAllAllowedCategoryTreeRequestFlo MyRequest)
        {
            MyRequest.GetHeaderMessage();
            SetSessionData(MyRequest);
            return View(new GetAllAllowedCategoryTreeMessageFlo(MyRequest));
        }
